...
export default function Feedback() {
    ...
    useEffect(() => {
        document.addEventListener('DOMContentLoaded', function () {
            // initializeSplideSlider(); // Initialize the slider when the component mounts
    ...
    return (
        <>
            <div className="feedback-section">
                <div className="section  feedback-section__wrapper">
                                ...
                                <div className="col-md-8 col-xl-6">
                                    <div className="text-center">
                                        <span className="section__particles">
                                            <span className="section__subtitle section__subtitle-dash text--white"> Feedback </span>
                                        </span>
                                        <h2 className="section__title mt-2 text--white">
                                            What our visitor says about <span>Viserzoo</span>
                                        </h2>
                                        <p className="section__para mx-auto text--white">
                                        ...
                                        <div className="feedback-card">
                                            <div className="feedback-card__head">
                                                ...
                                                <div className="flex-grow-1">
                                                    <h5 className="mt-0 mb-1">Robarts Jons</h5>
                                                    <span className="d-block sm-text"> Visitor </span>
                                                </div>
                                            </div>
                                            <div className="feedback-card__body">
                                                <p className="feedback-card__text mb-0">
                    ...
                    {/* <div className="container">
                        <div className="row">
                            <div className="col-12">
                                <div className="feedback-slider">
                                    <div className="splide" id="feedback-slider">
                                        <div className="feedback-slider__item splide__slide">
                                            <div className="feedback-card__head">
                                                <div className="user user--xl">
                                                    <img
                                                        src="assets/images/people-3.jpg"
                    ...
                    {/* <section className="splide" aria-label="Splide Basic HTML Example">
                        <div className="splide__track">
                            <ul className="splide__list">
                                <li className="splide__slide"><div className="feedback-card">
                                    <div className="feedback-card__head">
                                        <div className="user user--xl">
                                            <img
                                                src="assets/images/people-3.jpg"
