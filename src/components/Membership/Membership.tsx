              ...
              <div className="col-md-8 col-xl-6 col-xxl-5">
                <div className="text-center">
                  <span className="section__particles">
                    <span className="section__subtitle section__subtitle-dash"> Membership Plan </span>
                  </span>
          ...
          <div className="row g-4">
            <div className="col-md-4">
              <div className="member-card">
                <img src="assets/images/member-card-1.png" alt="image" className="member-card__img" />
            ...
            <div className="col-md-4">
              <div className="member-card">
                <img src="assets/images/member-card-2.png" alt="image" className="member-card__img" />
                <div className="member-card__content">
            ...
            <div className="col-md-4">
              <div className="member-card">
                <img src="assets/images/member-card-3.png" alt="image" className="member-card__img" />
                <div className="member-card__content">
