                  ...
                  <div className="col-md-6">
                    <div className="text-center text-md-start d-grid gap-2">
                      ...
                      <a href="index.html" className="logo mx-auto ms-md-0">
                        <img src="assets/images/logo-alt.png" alt="viserhyip" className="img-fluid logo__is" />
                      </a>
                      {/* Logo End */}
                    ...
                    <div className="text-center text-md-end">
                      ...
                      <div className="newsletter mx-auto ms-md-auto me-md-0">
                        <div className="newsletter__container rounded-pill">
                          <input type="text" className="form-control form--control newsletter__input flex-grow-1 rounded-pill" placeholder="Subscribe now.." />
