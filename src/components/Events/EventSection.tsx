                ...
                <div className="event-section__content text-center text-lg-start">
                  ...
                  <div className="upcoming-slider">
                    <div className="upcoming-slider__item">
                      <div className="upcoming-card">
                        <div className="upcoming-card__img">
                          <img src="assets/images/event-img-1.png" alt="image" className="upcoming-card__img-is" />
                        </div>
                        <div className="upcoming-card__content">
                          <h5 className="upcoming-card__title">
                            Medina Deer
                          </h5>
                          <ul className="list">
                            <li>
                    ...
                    <div className="upcoming-slider__item">
                      <div className="upcoming-card">
                        <div className="upcoming-card__img">
                          <img src="assets/images/event-img-2.png" alt="image" className="upcoming-card__img-is" />
                        </div>
                        <div className="upcoming-card__content">
                          <h5 className="upcoming-card__title">
                            Medina Deer
                    ...
                    <div className="upcoming-slider__item">
                      <div className="upcoming-card">
                        <div className="upcoming-card__img">
                          <img src="assets/images/event-img-3.png" alt="image" className="upcoming-card__img-is" />
                        </div>
                        <div className="upcoming-card__content">
                          <h5 className="upcoming-card__title">
                            Medina Deer
